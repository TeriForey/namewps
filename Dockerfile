...
MAINTAINER https://github.com/TeriForey/testbird

LABEL Description="testbird WPS" Vendor="Birdhouse"
...
COPY . /opt/birdhouse/src/testbird

# cd into application
WORKDIR /opt/birdhouse/src/testbird
